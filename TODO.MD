...
<!-- PageInsight -->
- [ ] Carousel being 1x1 images is causing issues. Lazy loading/deferred loading is better
...
- [ ] Contact page has fonts connected through google
- [ ] Footer apply change button is misaligned